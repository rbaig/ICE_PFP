...
| :--- | :--- | :--- | :--- | :--- |
| **P2** | Producció | Tema / Problemari / Solucionari / Sessió | Unitat de producció | Binaris individuals |
| **P3** | Revisió de Conjunt | Corpus sencer | - | Binaris globals |
| **P4** | Revisió Externa | Tema + Problemari + Solucionari / Sessió | Unitat de revisió (externa) | Binaris col·legiats |
...
:   Harmonització del lèxic i l'estil segons les convencions de `contrib.qmd`. Les fases U2 i U3 s'alternen iterativament fins a satisfer la DoD-P2.
**U4. Figures**
...
![Cicle de producció de cada unitat de producció. Les fases U2 i U3 s'alternen iterativament fins a satisfer la DoD-P2. La fase U6 capitalitza l'aprenentatge acumulat per a les unitats següents.](figures/unitat_produccio.svg){#fig-unitat-produccio width="45%"}

##### *Definition of Done* de P2 (DoD-P2) {.unnumbered}
...
##### *Definition of Done* de P3 (DoD-P3) {.unnumbered}

La DoD-P3 s'aplica al corpus sencer (no tema per tema) i verifica la coherència global del conjunt:

- Tots els fitxers `.qmd` han superat la DoD-P2.
...
##### *Definition of Done* de P4 (DoD-P4) {.unnumbered}
...
- ***Definitions of Done* (DoD-P2, P3 i P4)**: Sistema de criteris de tancament per fase (vegeu @sec-enfocament-metodologic). Actuen com a instrument de verificació formal en cada fase del procés.
