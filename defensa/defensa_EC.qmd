...
format:
  revealjs:
    ...
    include-after-body:
      ...
      # defaultTiming = temps mitjà per slide, en segons (840 s totals / 13 slides).
      - text: |
          <script>
          document.addEventListener('DOMContentLoaded', function() {
            if (window.Reveal) {
              Reveal.configure({ defaultTiming: 65 });
            }
          });
          </script>
...
- capçaleres diapos: Fontsize títol a ~70% 
- captions
    - Captions: Reduir fontsize a ~40% la paraula "Figura", la numeració i la descripció.
    - Eliminar salt de línia entre "Figura x" i la descripció 
    - Incloure la configuració per projector format antic 
- vspace després de títol slide: taules i `>` (petit) vs. bullets i figures (quasi el doble). Slide 13 ha de pujar com a les taules per no desbordar per sota
- Última diapo: "Tots els objectius assolits ⟹ ..." Sense vinyeta i centrat
...
## Objectius específics {#sec-objectius data-timing="35"}
...
## L'obstacle: escala vs. recursos {#sec-obstacle data-timing="45"}
...
:::
Etapes d'una unitat de producció (x ∈ [1, 9], y ∈ [1, 6])
:::
...
## Un model sostenible i replicable a STEAM {#sec-model data-timing="70"}
...
::: {.lead}
El docent no queda substituït: 💥️ **és promogut a director** 💥️
:::
