...
![L'eix d'arquitectura de computadors del GEI (FIB-UPC). EC és el nexe central entre la lògica digital d'IC i el disseny d'alt rendiment d'AC.](figures/eix_arquitectura.svg){#fig-eix-arquitectura width="70%"}
...
TODO Explicar que hi ha dues etapes:
- Etapa de producció
    - Inputs: Corpus de materials MIPS (Teoria, Problemaris, Solucionaris, Laboratoris)
    - Productes: Corpus de materials RISC-V v0
    - Execució: PFP TODO data_d_inici -- juliol 2026
- Etapa d'explotació
    - Inputs: Corpus de materials RISC-V v0
    - Productes: Corpus de materials RISC-V v1 + Diapositives de classe
    - Execució: iterativa per quadrimestres,
        - 1a iteració: juliol 2026 -- setembre 2026
            - 2 professors
...
| :--- | :--- | :--- | :--- | :--- |
| **DoD-F2** | Producció | Tema o Problemari o Solucionari o Sessió | Unitat de producció | Binaris individuals |
| **DoD-F3** | Revisió de Conjunt | Corpus sencer | - | Binaris globals |
| **DoD-F4** | Revisió Externa | Tema + Problemari + Solucionari per tema; Sessió | Unitat de revisió (externa) | Binaris col·legiats |
: Estructura de les tres *Definitions of Done* del projecte. La granularitat de la unitat de treball és diferent en cada fase, cosa que permet un escrutini adaptat a l'objectiu de cadascuna. {#tbl-dods tbl-colwidths="[10,20,30,20,20]" .striped}
...
El cicle de producció de cada unitat de producció segueix les etapes de la @fig-unitat-produccio:

<!-- TODO actualitzar llista amb les fases de la figura -->
...
<!-- TODO actualitzar caption de la figura -->
![Cicle de producció unitària. Les etapes 2 i 3 són iteratives amb Claude fins a satisfer la *Definition of Done* de F2. L'etapa 5 capitalitza l'aprenentatge per a les unitats següents.](figures/unitat_produccio.svg){#fig-unitat-produccio width="80%"}
...
<!-- TODO dir que aquesta etapa inclou (òbviament) el manteniment i actualitaciós dels materials -->
<!-- TODO dir que la primera iteració inclourà la preparació de les diapositives -->
<!-- TODO dir s'hi poden incloure materials de suport a la docència. -->
<!-- TODO Explicar que aquesta etapa és iterativa i que el feedback del primer quadrimestre d'ús alimentarà una nova iteració de revisió externa per al segon quadrimestre. -->
...
<!-- TODO integrar referència a la figura @fig-etapa-explotacio -->

<!-- TODO actualitzar caption de la figura següent -->
![Fases de l'Etapa d'explotació. ](figures/etapa_explotacio.svg){#fig-etapa-explotacio width="70%"}
