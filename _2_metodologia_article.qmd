...
Cada unitat de producció de P2 segueix un cicle de sis fases seqüencials (@fig-unitat-produccio): **U1** (extracció i conversió assistida per IA, secció a secció, a partir del PDF original), **U2** (revisió tècnica: verificació del codi assemblador RISC-V al simulador RARS i revisió de la coherència tècnica), **U3** (revisió lingüística: harmonització del lèxic i estil, alternada iterativament amb U2), **U4** (generació de figures SVG), **U5** (actualització transversal del glossari `sigles.qmd` i altres materials afectats) i **U6** (refinament dels protocols de producció per capitalitzar l'aprenentatge en les unitats següents).
